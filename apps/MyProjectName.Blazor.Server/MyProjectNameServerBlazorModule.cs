...
using MyProjectName.Blazor.Server.Menus;
...
public class MyProjectNameServerBlazorModule : AbpModule
{
        ...
        Configure<AbpBundlingOptions>(options =>
        {
            ...
            options.StyleBundles.Configure(
                ...
                bundle =>
                {
                    ...
                    bundle.AddFiles("/MyProjectName.Blazor.Server.styles.css");
                }
            );
        });
    }
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(MyProjectNameServerBlazorModule).Assembly;
        });
    }
    ...
    private void ConfigureAutoMapper()
    {
        ...
        {
            options.AddMaps<MyProjectNameServerBlazorModule>();
        });
    }
